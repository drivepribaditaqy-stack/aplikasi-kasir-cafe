...
def insert_initial_data(conn):
    ...
    if count == 0:
        ...
        try:
            ...
            attendance_data = [
                (1, 1, '2025-08-24 05:59:58', None), (2, 1, '2025-08-24 06:00:21', None), (3, 1, '2025-08-24 06:03:00', None),
                (4, 1, '2025-08-24 06:03:07', None), (5, 1, '2025-08-24 06:19:06', None), (6, 1, '2025-08-24 06:19:20', None),
                (7, 1, '2025-08-24 19:06:27', None), (8, 1, '2025-08-24 19:09:25', None), (9, 1, '2025-08-24 19:09:56', None),
                (10, 1, '2025-08-24 19:10:00', None), (11, 1, '2025-08-24 19:10:04', None),
                (12, 1, '2025-08-24 19:02:36', '2025-08-25 01:02:45'), (13, 1, '2025-08-24 06:32:44', '2025-08-24 06:32:47'),
                (14, 1, '2025-08-24 06:45:23', '2025-08-24 06:45:30'), (15, 1, '2025-08-24 19:21:00', '2025-08-24 22:21:00')
            ]
...
def check_login():
    ...
    if st.session_state.logged_in:
        ...
        if st.sidebar.button("Logout"):
            # Hapus semua session state saat logout
        ...
        with st.form("login_form"):
            username = st.text_input("Username").lower() # Ubah username ke huruf kecil
...
def run_main_app():
    ...
    # (Sisa fungsi-fungsi manajemen data tetap sama)
    ...
    # --- UI SIDEBAR DENGAN HAK AKSES ---
    st.sidebar.title("MENU NAVIGASI")
    
    user_role = st.session_state.get("role", "Operator") # Default ke Operator jika peran tidak ditemukan
    
    # Tampilkan menu berdasarkan peran pengguna
    ...
    # (Kode untuk setiap halaman tetap sama)
    if menu == "🏠 Kasir":
            ...
            with col1:
                ...
                if st.button("Tambahkan ke Keranjang", use_container_width=True):
                    if product_name in st.session_state.cart:
                        ...
                        st.session_state.cart[product_name] = quantity
                    st.success(f"{quantity} x {product_name} ditambahkan.")
            with col2:
        ...
        with col1:
            ...
            selected_prod_id = st.selectbox("Pilih produk untuk diedit", [""] + products_df['id'].tolist())
        ...
        with col2:
            ...
            if not products_df.empty and not ingredients_df.empty:
                recipe_prod_id = st.selectbox("Pilih Produk untuk Resep", products_df['id'].tolist(), format_func=lambda x: products_df[products_df['id']==x]['name'].iloc[0])
        ...
        sales_query = "SELECT s.id, s.date, p.name as product_name, s.qty, p.price, (s.qty * p.price) as total_revenue FROM sales s JOIN products p ON s.product_id = p.id ORDER BY s.date DESC"
        ...
        with st.form("employee_form", clear_on_submit=True):
            ...
            if submitted:
                if selected_emp_id:
                    ...
                    st.success("Karyawan baru ditambahkan!")
                st.rerun()
        ...
        if not df_emp.empty:
            ...
            if st.button("Hapus Karyawan Terpilih", type="primary"):
                ...
                st.warning("Data karyawan dihapus.")
                st.rerun()
        ...
        if employees_df.empty:
            ...
            query_att = "SELECT a.id, e.name, a.check_in, a.check_out FROM attendance a JOIN employees e ON a.employee_id = e.id ORDER BY a.check_in DESC"
